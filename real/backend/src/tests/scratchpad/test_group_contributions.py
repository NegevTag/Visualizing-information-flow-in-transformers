...
from api_checks.utils import group_contributions
...
def test_basic_grouping_matches_reference():
    ...
    out = group_contributions(labels, make_contributions(mlp, attn))
...
def test_length_mismatch_raises(labels_len: int):
    ...
    with pytest.raises(Exception):
        group_contributions(labels, make_contributions(mlp, attn))
